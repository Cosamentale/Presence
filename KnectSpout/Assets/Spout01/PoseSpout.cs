...
public class PoseNetSpout : MonoBehaviour
{
    ...
    public Vector4[] posePositionsArray = new Vector4[17];
    public Vector4[] posePositionsArray2 = new Vector4[17];
    public Vector4[] posePositionsArray3 = new Vector4[17];
    public float pers01;
    public float pers02;
    public float pers03;
    //public Vector3[] pos;
    ...
    void Update()
    {
        ...
        float perso01 = 0; float perso02 = 0; float perso03 = 0;
        for (int i = 0; i < poses.Length; i++)
        {
            ...
            for (int j = 0; j < 17; j++)
            {
                ...
                perso01 = Mathf.Max(perso01, skeletons[0].keypoints[j].z);
                perso02 = Mathf.Max(perso02, skeletons[1].keypoints[j].z);
                perso03 = Mathf.Max(perso03, skeletons[2].keypoints[j].z);
            }
