...
{
	public class GettingStartedSendingDetec : MonoBehaviour
	{
       ...
       // public InfraredSourceDetectionFrame infra;
        void Start()
		{
		...
		void Update()
		{
          ...
          //  _oscOut.Send(address1, infra.floatArray1[0]);
          //  _oscOut.Send(address2, infra.floatArray1[1]);
          //  _oscOut.Send(address3, infra.floatArray1[2]);
          //
