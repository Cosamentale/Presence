   ...
   // public Vector2[] pos3 = new Vector2[17];
    ...
    void Update()
    {
        ...
        for (int i = 0; i < poses.Length; i++)
        {
            ...
            for (int j = 0; j < 17; j++)
            {
                pos1[j] = new Vector3(skeletons[0].keypoints[j].x, skeletons[0].keypoints[j].y, skeletons[0].keypoints[j].z);
              //  pos2[j] = new Vector3(skeletons[1].keypoints[j].x, skeletons[1].keypoints[j].y, skeletons[1].keypoints[j].z);
               // pos3[j] = new Vector3(skeletons[2].keypoints[j].x, skeletons[2].keypoints[j].y, skeletons[2].keypoints[j].z);
